...
import com.sanaari.springboot.training.crmwebapp.repositories.PagedProductRepository;
...
public class ProductAPIServiceImpl implements ProductAPIService {
	...
	@Autowired
	private PagedProductRepository pagedProdRepo;
	...
	public Page<Product> getAllProductsPaged(Pageable pageable) {
		// TODO Auto-generated method stub
		return pagedProdRepo.findAll(pageable);
	}
